    ...
    <div className="min-h-screen flex items-stretch justify-center bg-gray-100">
      ...
      <div className="flex max-w-4xl w-full bg-white rounded-lg shadow-md p-8 space-x-6">
        ...
        <div className="w-1/2 p-6 space-y-6 text-center h-full">
          <h1 className="text-2xl font-extrabold text-gray-800">Hello Doctor</h1>

          <div>
            <p className="text-gray-600 text-lg font-semibold">HEALTH CLINIC</p>
            <h5 className="text-sm text-gray-500 mt-2">
              Patient well-being is our top priority. Welcome! Register as a doctor or hospital.
            </h5>
          </div>

          <div className="space-y-2 mt-4">
            <h6 className="text-base font-medium text-gray-700">Are you a new Member?</h6>
          ...
          <div className="space-y-4">
            <Input
              type="email"
              placeholder="Register Hospital" 
              className="w-full p-2 border border-gray-300 rounded-lg text-[#0661A8]"
            />
            <Input
              type="email"
              placeholder="Register Doctor"
              className="w-full p-2 border border-gray-300 rounded-lg text-[#0661A8]"
            />
          </div>

          <div className="mt-16 space-y-16">
            <h6 className="text-lg font-semibold text-gray-800">Welcome! Patient Health Our Priority</h6>
